...
//funcao para adicionar a classe active no nav da pagina ativa
...
function script_files(){
    ...
    wp_enqueue_script('numberCounter', get_template_directory_uri() .'/assets/js/numberCounter.js', array(), false, true);
    wp_enqueue_script('inWindow', get_template_directory_uri() .'/assets/js/inWindow.js', array(), false, true);
