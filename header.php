...
<head>
    ...
    <link rel="icon" href="<?php echo get_bloginfo('template_url')?>/assets/images/logo2.svg">
...
<body>
    <nav class="navbar sticky-top navbar-expand-lg bg-dark align-middle stroke montserrat">
        <div class="container">
